...
Player(vec2d(0,100))
Mouse()
# graphics.set_render_layers(["chunks_layer",  "player_layer", "grass_layer", "mouse_layer","player_debug_layer", "chunks_debug", "mouse_debug_layer"])
# print(graphics.layers)
graphics.set_render_layers(["chunks_layer", "player_layer", "grass_layer", "mouse_layer"])
window.run()